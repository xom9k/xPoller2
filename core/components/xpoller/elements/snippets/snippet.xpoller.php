...
$modx->regClientScript($modx->getOption('xpoller_assets_url').'js/web/default.js');
$modx->lexicon->load('xpoller:translations');
...
if (empty($id)) {
	...
	if(!empty($idArray)) {
		...
		return $modx->lexicon("xpoller_question_err_ns");
	}
}
