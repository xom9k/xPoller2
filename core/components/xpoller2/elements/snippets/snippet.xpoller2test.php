...
if (empty($formOuterTpl)) {$formOuterTpl = "tpl.xPoller2.form.test.outer";}
...
if (empty($id)) {return $modx->lexicon("xpoller2_question_err_ns");}
if (!$modx->user->isAuthenticated($modx->context->key)) {return $modx->lexicon("xpoller2_need_auth");}
